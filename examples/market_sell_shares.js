/******************************************************************
*   This scripts is to demonstrate how to sell shares on a prediction market
*   using GnosisJS.
*   Prerequisites:
...
const outcomeIndex = "1"; // outcome to sell, is the index taken from the market outcomes array
const outcomeAmount = 0.5e18; // amount of shares to sell
...
.then(result => {
  ...
  console.info("[GnosisJS] > Started selling shares on market with address " + marketAddress);
  return new Promise((resolve, reject) => {
    gnosisInstance.sellOutcomeTokens({
...
.then(() => {
  console.info("[GnosisJS] > Shares were sold successfully.");
})
.catch(error => {
